...
{
    public class SingleResponseTask : TaskBase
    {
        ...
        public SingleResponseTask(Response response, CameraConfiguration configuration, int delay) : base(nameof(LastResponseTask))
        {
            _response = response;
